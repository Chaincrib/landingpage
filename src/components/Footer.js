import chaincrib from '../images/Chaincrib.png';
import logo from '../images/logo.png';

function Footer() {
    return (
        <section className='mb-20 max-[800px]:mb-10'>
            <div className="flex max-[800px]:flex-col max-[800px]:w-full justify-between text-white">
                ...
                <div className='flex gap-32 max-[800px]:flex max-[800px]:justify-between'>
                    <div>
                        <h3 className='text-lg mb-5'>Resources</h3>
                        <ul className='max-[800px]:flex max-[800px]:flex-col gap-5'>
                            <li>
                                <a href="/">Deck</a>
                            </li>
                            <li>
                ...
                <div>
                    ...
                    <p>Zug, Switzerland</p>
                    <p>Email: <a href="mailto:info@chaincrib.com">info@chaincrib.com</a></p>
                    <div className='mt-5'>
                        <a href="/" className='bg-white px-8 py-3 rounded-lg text-black font-medium'>Contact Form for immediate inquiries</a>
                    </div>
                </div>
